import { E } from "chart.js/dist/chunks";

export const OverviewPriceIcon = (props: any): JSX.Element => (
	<svg
		width="24"
		height="24"
		viewBox="0 0 24 24"
